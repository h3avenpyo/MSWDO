...
class SeniorController extends Controller
{
    ...
    public function showIdCard($id)
    {
        ...
        return view('admin.senior.id-card', compact('senior', 'oscaHeadSignature', 'mswdoOfficerSignature'));
    }
    ...
    public function downloadIdCardPdf($id)
    {
        try {
            ...
            $pdf = Pdf::loadView('admin.senior.id-card-pdf', compact('senior', 'oscaHeadSignature', 'mswdoOfficerSignature'));
