    ...
    <div style="background:#fff;border-radius:16px;width:100%;max-width:640px;max-height:85vh;display:flex;flex-direction:column;box-shadow:0 20px 25px -5px rgba(0,0,0,0.2);overflow:hidden;">
        <div style="display:flex;justify-content:space-between;align-items:center;padding:20px 24px;border-bottom:1px solid #E5E7EB;background:#1A237E;">
            <div style="display:flex;align-items:center;gap:10px;">
                ...
                <div>
                    <h3 style="margin:0;font-size:18px;font-weight:700;color:#fff;">Select Senior to Edit</h3>
                    <p style="margin:2px 0 0 0;font-size:12px;color:rgba(255,255,255,0.8);">Choose which senior citizen record to update</p>
                </div>
            </div>
            <button type="button" onclick="closeSeniorSelectModal()" style="background:transparent;border:none;color:#fff;cursor:pointer;padding:4px;display:flex;align-items:center;justify-content:center;border-radius:6px;">
