...
<head>
    ...
    <style>
        ...
        .mobile-bottom-nav-item [data-lucide],.mobile-bottom-nav-item i{width:20px;height:20px;}
        .mobile-bottom-nav-item:hover{color:#1A237E;}
        .mobile-nav-extra{padding-top:4px;margin-top:2px;}
        @media(max-width:767px){.main,.main-content{margin-left:0 !important;max-width:100% !important;height:auto !important;overflow:visible !important;padding:12px 14px !important;padding-top:66px !important;padding-bottom:140px !important;}.top-navbar{display:none !important;}.hamburger-btn{display:none !important;}.mobile-header{display:flex !important;}.mobile-bottom-nav{display:flex !important;flex-direction:column !important;}}
...
<div class="mobile-header"><div><div class="mobile-header-sub">Senior Citizen</div><div class="mobile-header-title">ID Card</div></div><div class="mobile-avatar-hdr">{{ $mhI }}</div></div>
...
<div class="mobile-bottom-nav"><div class="mobile-bottom-nav-row"><a href="/admin/senior" class="mobile-bottom-nav-item"><i class="fas fa-chart-line"></i><span>Dashboard</span></a><a href="/admin/senior/registration" class="mobile-bottom-nav-item"><i class="fas fa-user-plus"></i><span>Register</span></a><a href="/admin/senior/masterlist" class="mobile-bottom-nav-item active"><i class="fas fa-list"></i><span>Masterlist</span></a><a href="/admin/senior/birthdays" class="mobile-bottom-nav-item"><i class="fas fa-birthday-cake"></i><span>Birthdays</span></a><button type="button" class="mobile-bottom-nav-item" onclick="toggleMobileMoreNav()"><i class="fas fa-chevron-up" id="mobileMoreIcon"></i><span>More</span></button></div><div class="mobile-bottom-nav-row mobile-nav-extra" id="mobileNavExtra" style="display:none;"><a href="/admin/senior/payouts-history" class="mobile-bottom-nav-item"><i class="fas fa-history"></i><span>Payouts</span></a><a href="/admin/senior/statistics" class="mobile-bottom-nav-item"><i class="fas fa-chart-bar"></i><span>Stats</span></a><a href="/admin/senior/archive" class="mobile-bottom-nav-item"><i class="fas fa-archive"></i><span>Archive</span></a><a href="#" onclick="confirmLogout(event)" class="mobile-bottom-nav-item"><i class="fas fa-sign-out-alt"></i><span>Logout</span></a></div></div>
<form id="logout-form" action="{{ route('admin.logout') }}" method="POST" style="display: none;">
    @csrf
</form>

<script>
    function toggleMobileMoreNav(){const extra=document.getElementById('mobileNavExtra');const icon=document.getElementById('mobileMoreIcon');if(!extra)return;if(extra.style.display==='none'||extra.style.display===''){extra.style.display='flex';if(icon){icon.className='fas fa-chevron-down';}}else{extra.style.display='none';if(icon){icon.className='fas fa-chevron-up';}}}
