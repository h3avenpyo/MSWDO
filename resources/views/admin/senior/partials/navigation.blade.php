...
<div class="sidebar" id="sidebar">
    ...
    <ul class="sidebar-menu">
        ...
        <li><a href="/admin/senior/in-between/eligibility-list" class="{{ in_array(($active ?? ''), ['in-between', 'in-between-eligibility', 'in-between-history']) ? 'active' : '' }}"><i data-lucide="gift" style="width:20px;height:20px"></i><span>In-Between Benefits</span></a></li>
