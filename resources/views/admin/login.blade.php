...
<head>
    ...
    <style>
        ...
        *::after {
        ...
        .module-list-items li:last-child {
            border-bottom: none;
        }

        .module-list-items li:hover {
            padding-left: .45rem;
        }
        ...
        <div class="auth-card">
            ...
            <section class="login-panel" aria-label="Login form">
                ...
                <div class="mode-toggle" id="loginModeToggle">
                    <button type="button" class="mode-btn active" id="modePasswordBtn"
                        onclick="setLoginMode('password')">Password</button>
                    <button type="button" class="mode-btn" id="modeCodeBtn" onclick="setLoginMode('code')">Email
                        Code</button>
                </div>

                <!-- Password login -->
                <div class="login-body">
                    <form id="loginForm" class="login-mode-form" method="POST" action="{{ route('admin.login') }}"
                        novalidate>
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-wrap">
                                ...
                                <button type="button" class="password-toggle" id="passwordToggle"
                                    onclick="togglePassword()" aria-label="Show password" title="Show password">
                    ...
                    <div id="codeLoginSection" class="login-mode-form is-hidden">
                        <div id="codeSentNotice" class="code-sent-notice" style="display: none;">
                            ...
                            <span>A 6-digit code was sent to <strong id="codeSentEmail"></strong>. Enter it
                                below.</span>
                        </div>

                        <div id="codeSendStep">
                            <form id="codeSendForm" method="POST" action="{{ route('admin.login.code.send') }}"
                                novalidate>
                                @csrf
                                <div class="form-group">
                                    ...
                                    <div class="input-wrap">
                                        ...
                                        <input type="email" id="codeEmail" name="email" required autocomplete="email"
                                            class="form-input" placeholder="admin@mswdo.gov.ph"
                                            value="{{ old('email') }}">
                                    </div>
                                </div>
                        ...
                        <div id="codeVerifyStep" style="display: none;">
                            <div style="border-top: 1px solid #E2E8F0; padding-top: 1.25rem;">
                                <form id="codeVerifyForm" method="POST" action="{{ route('admin.login.code.verify') }}"
                                    novalidate>
                                    @csrf
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-wrap">
                                            ...
                                            <input type="text" id="code" name="code" required maxlength="6"
                                                ...
                                                class="form-input" placeholder="6-digit code">
                                        </div>
                                    </div>

                                    <div id="codeVerifyError" class="form-error" style="display: none;" role="alert">
                                    </div>
                                ...
                                <p class="resend-hint">Didn't get it? <button type="button" id="codeResendBtn">Send a
                                        new code</button></p>
                            </div>
                        </div>
                    </div>
                ...
                <a href="#" class="support-link">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2"
                        stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round"
                            d="M12 21a9 9 0 1 0-9-9 9 9 0 0 0 9 9Zm0 0a8.949 8.949 0 0 0 4.951-1.488A3.987 3.987 0 0 0 9 16.5M12 21a8.949 8.949 0 0 1-4.951-1.488A3.987 3.987 0 0 1 15 16.5m-3-8.25a3 3 0 1 1-6 0 3 3 0 0 1 6 0Zm6 0a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" />
                    </svg>
