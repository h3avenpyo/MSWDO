...
<body>
    <div class="sidebar" id="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li><a href="/admin/social-case-studies" class="active"><i class="fas fa-file-alt"></i> Case Studies</a></li>
    ...
    <div class="main-content">
        <nav class="top-navbar">
            <div>
                <h5 class="page-title">Social Case Studies</h5>
                <p class="page-subtitle">Manage social case studies created after eligibility validation.</p>
            </div>
