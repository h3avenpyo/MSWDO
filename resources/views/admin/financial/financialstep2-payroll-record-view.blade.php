...
<head>
    ...
    <link href="{{ asset('css/financialstep2-payroll-record-view.css') }}" rel="stylesheet">
</head>

<body data-autoprint="{{ !empty($autoprint) ? 'true' : 'false' }}">
    ...
    <script src="{{ asset('js/financialstep2-payroll-record-view.js') }}"></script>
</body>
