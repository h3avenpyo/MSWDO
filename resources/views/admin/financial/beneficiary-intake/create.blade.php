    ...
    <form action="{{ route('admin.beneficiary-intake.store') }}" method="POST" id="intakeForm">
        ...
        <div class="form-card">
            <div class="card-body p-4">
                ...
                <div class="row g-3">
                    <div class="col-md-3">
                        <label class="form-label" for="beneficiary_contact_number">Numero ng Telepono (Mobile No.) <span
                                class="required-star">*</span></label>
                        <input type="text"
        ...
        <div class="form-card">
            <div class="card-body p-4">
                ...
                <div id="representative_section" class="rep-card-disabled">
                    ...
                    <div class="row g-3">
                        <div class="col-md-3">
                            <label class="form-label" for="rep_contact_number">Numero ng Telepono <span
                                    class="required-star rep-star">*</span></label>
                            <input type="text"
