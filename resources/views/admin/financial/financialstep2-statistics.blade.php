...
<link
    href="{{ asset('css/financialstep2-statistics.css') }}?v={{ file_exists(public_path('css/financialstep2-statistics.css')) ? filemtime(public_path('css/financialstep2-statistics.css')) : time() }}"
    rel="stylesheet">
@endsection
...
<div class="container-fluid">
    ...
    <div class="screen-dashboard-container no-print">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-2">
            <div>
                ...
                <p class="text-muted small mb-0">
                    Real-time beneficiary distributions, demographic breakdown, and sector financial assistance reports
                    <span
                        class="ms-2 badge {{ $isAll ? 'bg-secondary bg-opacity-10 text-secondary' : 'bg-primary bg-opacity-10 text-primary' }} border fw-semibold">
            ...
            <div class="d-flex align-items-center gap-2 flex-wrap no-print">
                ...
                <form method="GET" action="{{ route('admin.financial.financialstep2.statistics') }}"
                    class="d-flex align-items-center m-0" id="monthFilterForm">
                    <div class="input-group input-group-sm" style="min-width: 230px;">
                        ...
                        <select name="month" id="monthFilterSelect"
                            class="form-select form-select-sm border-start-0 fw-semibold"
                            onchange="document.getElementById('monthFilterForm').submit()"
                            title="Select month to filter statistics" aria-label="Select Month">
                ...
                <button type="button"
                    class="btn btn-primary btn-sm rounded-pill px-3.5 py-2 fw-semibold shadow-xs d-inline-flex align-items-center gap-2 btn-print-statistics"
                    onclick="window.print()" title="Print official statistics report">
                    <i class="fas fa-print"></i>
                    <span>Print Statistics</span>
                </button>
                <a href="{{ route('admin.financial.financialstep2') }}"
                    class="btn btn-outline-primary btn-sm rounded-pill px-3 fw-semibold shadow-xs">
                        ...
                        <div class="flex-grow-1 min-w-0 me-2">
                            ...
                            <div class="text-muted text-xs mt-1">
                                <span class="text-success fw-bold"><i class="fas fa-check-circle me-1"></i>{{
                                    number_format($totalClaimed) }}</span> Claimed
                                @if($totalBeneficiaries > 0)
                                ({{ round(($totalClaimed / $totalBeneficiaries) * 100, 1) }}%)
                                @endif
                            </div>
                        </div>
                        <div class="rounded-circle bg-primary-subtle text-primary p-3 d-flex align-items-center justify-content-center flex-shrink-0"
                ...
                <div class="card border-0 shadow-xs rounded-4 p-3 bg-white h-100">
                    <div class="d-flex align-items-center justify-content-between">
                        <div class="flex-grow-1 min-w-0 me-2">
                            ...
                            <div class="text-muted text-xs mt-1">
                                Claimed: <strong class="text-dark">&#8369;{{ number_format($totalClaimedAmount, 2)
                                    }}</strong>
                            </div>
                        </div>
                        <div class="rounded-circle bg-success-subtle text-success p-3 d-flex align-items-center justify-content-center flex-shrink-0"
                            style="width: 48px; height: 48px;">
                ...
                <div class="card border-0 shadow-xs rounded-4 p-3 bg-white h-100">
                    <div class="d-flex align-items-center justify-content-between">
                        <div class="flex-grow-1 min-w-0 me-2">
                            ...
                            <h4 class="fw-bold mb-0 text-dark text-break" style="font-size: 1.25rem; line-height: 1.25;"
                                title="{{ $topBarangay ?? 'N/A' }}">
                                {{ $topBarangay ?? 'N/A' }}
                            </h4>
                            <div class="text-muted text-xs mt-1">
                                <strong class="text-dark">{{ number_format($topBarangayCount) }}</strong> beneficiaries
                                recorded
                            </div>
                        </div>
                        <div class="rounded-circle bg-info-subtle text-info p-3 d-flex align-items-center justify-content-center flex-shrink-0"
                            style="width: 48px; height: 48px;">
                ...
                <div class="card border-0 shadow-xs rounded-4 p-3 bg-white h-100">
                    <div class="d-flex align-items-center justify-content-between">
                        <div class="flex-grow-1 min-w-0 me-2">
                            ...
                            <h4 class="fw-bold mb-0 text-warning text-break"
                                style="font-size: 1.25rem; line-height: 1.25;" title="{{ $topSector ?? 'N/A' }}">
                                {{ $topSector ?? 'N/A' }}
                            </h4>
                            <div class="text-muted text-xs mt-1">
                        ...
                        <div class="rounded-circle bg-warning-subtle text-warning p-3 d-flex align-items-center justify-content-center flex-shrink-0"
                            style="width: 48px; height: 48px;">
            ...
            <div class="chart-card-header">
                <div>
                    <div class="d-flex align-items-center gap-2 mb-1">
                        <span
                            class="badge bg-success-subtle text-success fw-bold px-2.5 py-1 rounded-pill text-2xs text-uppercase tracking-wider">
                    ...
                    <p class="chart-card-subtitle">Number of beneficiaries who received financial assistance per
                        Barangay in Silang</p>
                </div>
                <div class="d-flex align-items-center gap-2 flex-wrap no-print">
                    <!-- Live Search Filter -->
                    <div class="position-relative search-box-wrapper">
                        <i
                            class="fas fa-search position-absolute top-50 start-0 translate-middle-y ms-2.5 text-muted text-xs"></i>
                        <input type="text" id="barangaySearchInput"
                            class="form-control form-control-sm rounded-pill ps-4 pe-3 bg-light border-0 text-xs"
                            placeholder="Search barangay...">
                    </div>

                    <!-- View Limits (Top 10 / Top 25 / All) -->
                    <div class="btn-group btn-group-sm rounded-pill bg-light p-0.5 shadow-none" role="group"
                        aria-label="Barangay View Limit">
                        <button type="button"
                            class="btn btn-sm rounded-pill px-2.5 py-1 text-xs fw-semibold btn-barangay-limit active"
                            data-limit="10">Top 10</button>
                        <button type="button"
                            class="btn btn-sm rounded-pill px-2.5 py-1 text-xs fw-semibold btn-barangay-limit"
                            data-limit="25">Top 25</button>
                        <button type="button"
                            class="btn btn-sm rounded-pill px-2.5 py-1 text-xs fw-semibold btn-barangay-limit"
                            data-limit="all">All ({{ count($barangayStats) }})</button>
                    </div>

                    <!-- Sort Toggle -->
                    <button type="button" id="btnSortBarangays"
                        class="btn btn-sm btn-light border-0 shadow-xs rounded-pill px-2.5 py-1 fw-semibold text-xs text-muted"
                        title="Toggle Sort: Highest vs A-Z">
                        <i class="fas fa-sort-amount-down me-1 text-success"></i> <span
                            id="barangaySortLabel">Highest</span>
                    </button>

                    <span id="barangayActiveCountBadge"
                        class="badge bg-success-subtle text-success rounded-pill px-2.5 py-1 text-xs fw-semibold">
                    ...
                    <div class="col-lg-7">
                        <div class="p-3 rounded-4 bg-light h-100 d-flex flex-column">
                            <div class="d-flex justify-content-between align-items-center mb-2">
                                ...
                                <span id="barangayChartShowingText" class="text-muted text-xs">Showing top 10
                                    barangays</span>
                            </div>
                            ...
                            <div class="chart-scroll-wrapper flex-grow-1" id="barangayChartScrollContainer">
                                <div class="barangay-chart-inner" id="barangayChartInner"
                                    style="position: relative; width: 100%; min-height: 380px;">
                    ...
                    <div class="col-lg-5">
                        <div class="p-3 rounded-4 bg-light h-100 d-flex flex-column">
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                ...
                                <span id="barangayListCountText" class="text-muted text-xs">{{ count($barangayStats) }}
                                    records</span>
                            </div>
                            <div class="barangay-list-container flex-grow-1" id="barangayListContainer">
                                ...
                                <div class="barangay-card-item" data-name="{{ strtolower($brgyName) }}">
                                    <div class="d-flex align-items-center gap-2 overflow-hidden me-2">
                                        <div
                                            class="barangay-rank-badge {{ $loop->iteration === 1 ? 'bg-warning text-dark' : ($loop->iteration === 2 ? 'bg-secondary text-white' : ($loop->iteration === 3 ? 'bg-success-subtle text-success' : 'bg-white text-muted shadow-xs')) }}">
                                            {{ $loop->iteration }}
                                        </div>
                                        <div class="text-truncate">
                                            <div class="fw-bold text-dark small text-truncate" title="{{ $brgyName }}">
                                                {{ $brgyName }}</div>
                                            <div class="text-muted text-2xs">{{ $bData['formatted_amount'] }} granted
                                            </div>
                                        </div>
                                    </div>
                                    <div class="d-flex align-items-center gap-2 flex-shrink-0">
                                        <span class="fw-bold text-dark small">{{ number_format($bData['beneficiaries'])
                                            }} <span class="text-muted fw-normal">cases</span></span>
                                        <span
                                            class="badge bg-success-subtle text-success fw-bold px-2 py-1 text-xs rounded-pill">
                                            {{ $bData['percentage'] }}%
                                        </span>
                                    </div>
                                </div>
                                @empty
                                <div class="text-muted text-center py-4 small">No barangay assistance records found.
                                </div>
                                @endforelse
                            </div>
                ...
                <div class="card border-0 shadow-xs rounded-4 bg-white h-100 d-flex flex-column mb-0 overflow-hidden">
                    <div class="chart-card-header">
                        <div>
                            <div class="d-flex align-items-center gap-2 mb-1">
                                <span
                                    class="badge bg-primary-subtle text-primary fw-bold px-2.5 py-1 rounded-pill text-2xs text-uppercase tracking-wider">
                            ...
                            <p class="chart-card-subtitle">Sectors receiving financial assistance, arranged highest to
                                lowest</p>
                        </div>
                        <div class="d-flex align-items-center gap-2 flex-wrap no-print">
                            <!-- Live Search Filter -->
                            <div class="position-relative search-box-wrapper">
                                <i
                                    class="fas fa-search position-absolute top-50 start-0 translate-middle-y ms-2.5 text-muted text-xs"></i>
                                <input type="text" id="sectorSearchInput"
                                    class="form-control form-control-sm rounded-pill ps-4 pe-3 bg-light border-0 text-xs"
                            ...
                            <div class="btn-group btn-group-sm rounded-pill bg-light p-0.5 shadow-none" role="group"
                                aria-label="Sector Metric">
                                <button type="button"
                                    class="btn btn-sm rounded-pill px-2.5 py-1 text-xs fw-semibold btn-sector-metric active"
                                    data-metric="cases">Cases</button>
                                <button type="button"
                                    class="btn btn-sm rounded-pill px-2.5 py-1 text-xs fw-semibold btn-sector-metric"
                                    data-metric="amount">Grants (₱)</button>
                            </div>

                            <!-- View Limits (Top 5 / Top 10 / All) -->
                            <div class="btn-group btn-group-sm rounded-pill bg-light p-0.5 shadow-none" role="group"
                                aria-label="Sector View Limit">
                                <button type="button"
                                    class="btn btn-sm rounded-pill px-2 py-1 text-xs fw-semibold btn-sector-limit"
                                    data-limit="5">Top 5</button>
                                <button type="button"
                                    class="btn btn-sm rounded-pill px-2 py-1 text-xs fw-semibold btn-sector-limit active"
                                    data-limit="10">Top 10</button>
                                <button type="button"
                                    class="btn btn-sm rounded-pill px-2 py-1 text-xs fw-semibold btn-sector-limit"
                            ...
                            <span id="sectorActiveCountBadge"
                                class="badge bg-primary-subtle text-primary rounded-pill px-2.5 py-1 text-xs fw-semibold">
                    ...
                    <div class="p-3 flex-grow-1 d-flex flex-column">
                        <div class="p-3 rounded-4 bg-light mb-3 flex-grow-1 d-flex flex-column">
                            <div class="d-flex justify-content-between align-items-center mb-2">
                                <span id="sectorChartShowingText" class="text-muted text-xs">Showing top 10
                                    sectors</span>
                                <span id="sectorChartMetricBadge"
                                    class="badge bg-white text-dark shadow-xs rounded-pill px-2 py-0.5 text-2xs">Beneficiary
                                    Count</span>
                            </div>
                            <div class="chart-scroll-wrapper flex-grow-1" id="sectorChartScrollContainer"
                                style="max-height: 320px;">
                                <div class="sector-chart-inner" id="sectorChartInner"
                                    style="position: relative; width: 100%; min-height: 260px;">
                        ...
                        <div class="sector-list-container" id="sectorListContainer" style="max-height: 210px;">
                            ...
                            <div class="sector-card-item" data-name="{{ strtolower($item['sector']) }}">
                                <div class="d-flex align-items-center justify-content-between">
                                    <div class="d-flex align-items-center gap-2 overflow-hidden me-2">
                                        <div
                                            class="sector-rank-badge {{ $index === 0 ? 'bg-warning text-dark' : ($index === 1 ? 'bg-secondary text-white' : ($index === 2 ? 'bg-primary-subtle text-primary' : 'bg-white text-muted shadow-xs')) }}">
                                            {{ $index + 1 }}
                                        </div>
                                    ...
                                    <div class="text-end flex-shrink-0">
                                        <div class="fw-bold text-dark small">
                                            {{ number_format($item['beneficiaries']) }} <span
                                                class="text-muted fw-normal">recipients</span>
                                        </div>
                                ...
                                <div class="sector-progress">
                                    <div class="progress-bar bg-primary" role="progressbar"
                                        style="width: {{ $item['percentage'] }}%; border-radius: 999px;"
            ...
            <div class="col-lg-5">
                <div class="card border-0 shadow-xs rounded-4 bg-white h-100 d-flex flex-column mb-0 overflow-hidden">
                    <div class="chart-card-header">
                        <div>
                            <h3 class="chart-card-title">
                                <i class="fas fa-venus-mars text-danger me-2"></i>Male & Female Beneficiaries
                            </h3>
                    ...
                    <div class="p-3 border-top bg-light mt-auto">
                        <div class="gender-pill-box">
                            ...
                            <div class="d-flex align-items-center gap-2">
                                ...
                                <span class="badge bg-primary-subtle text-primary rounded-pill text-xs">{{
                                    $malePercentage }}%</span>
                            </div>
                        </div>
                        <div class="gender-pill-box mb-0">
                            <div class="d-flex align-items-center gap-2">
                                <div class="rounded-circle"
                                    style="width: 12px; height: 12px; background-color: #E11D48;"></div>
        ...
        <div class="card border rounded-3 bg-white mb-4 shadow-none">
            <div class="card-header bg-white py-3 px-4 border-bottom">
                <div class="d-flex justify-content-between align-items-center flex-wrap gap-2">
                    <div>
                        ...
                        <p class="text-muted small mb-0">Frequently reported medical conditions and assistance reasons
                            among beneficiaries, ordered highest to lowest.</p>
                    </div>
                    <div class="d-flex align-items-center gap-2 no-print">
                        <span id="medicalActiveCountBadge"
                            class="badge bg-light text-secondary border fw-normal py-1.5 px-2.5">
            ...
            <div class="card-body p-4">
                ...
                <div>
                    <div class="d-flex justify-content-between align-items-center mb-2">
                        <span class="text-secondary small fw-bold text-uppercase" style="letter-spacing: 0.5px;">Summary
                            Directory</span>
                        <span id="medicalListCountText" class="text-muted small">{{ count($medicalRanked) }}
                            records</span>
                    </div>
                    <div class="table-responsive border rounded-2" style="max-height: 380px; overflow-y: auto;">
                        <table class="table table-sm table-hover align-middle mb-0" id="medicalListContainer">
                            <thead class="table-light sticky-top">
                                <tr>
                                    ...
                                    <th class="text-end fw-semibold text-dark" style="width: 170px;">Assistance Granted
                                    </th>
                                </tr>
                            </thead>
                            <tbody>
                                ...
                                <tr class="medical-card-item" data-name="{{ strtolower($item['concern']) }}">
                                    ...
                                    <td class="text-end small">{{ number_format($item['beneficiaries']) }} <span
                                            class="text-muted">cases</span></td>
                                    <td class="text-end text-muted small">{{ $item['percentage'] }}%</td>
                                    <td class="text-end fw-semibold text-dark small">{{ $item['formatted_amount'] }}
                                    </td>
                                </tr>
                                @empty
                                <tr>
                                    <td colspan="5" class="text-muted text-center py-3 small">No medical records found.
                                    </td>
                                </tr>
                                @endforelse
                            </tbody>
    ...
    <div class="print-report-document">
        ...
        <div class="report-header-banner">
            <div class="d-flex align-items-center justify-content-between pb-2 mb-2 border-bottom border-2 border-dark">
                ...
                <div class="text-center flex-grow-1 px-2">
                    ...
                    <div class="report-sub-title">Step 2: Financial Assistance, Sector Allocation &amp; Demographic
                        Analytics Overview &bull; {{ $isAll ? 'Overall Records' : $selectedMonthLabel }}</div>
                </div>
            ...
            <table class="report-meta-table mb-3">
                <tr>
                    ...
                    <td class="report-meta-cell" style="width: 25%;">
                        ...
                        <div class="report-meta-val" style="font-weight: 800; color: #166534;">&#8369;{{
                    ...
                    <td class="report-meta-cell text-end" style="width: 25%;">
                        ...
                        <div class="report-meta-val" style="font-weight: 800; color: #1A237E;">{{
                            number_format($totalBeneficiaries) }} Recipients</div>
                    </td>
                </tr>
            </table>
                    ...
                    <tr>
                        <td class="report-summary-cell" style="width: 25%;">
                            ...
                            <div class="report-summary-sub">
                                <span style="color: #166534; font-weight: 700;">{{ number_format($totalClaimed) }}
                                    Claimed</span>
                                @if($totalBeneficiaries > 0)
                                ({{ round(($totalClaimed / $totalBeneficiaries) * 100, 1) }}%)
                                @endif
                        ...
                        <td class="report-summary-cell" style="width: 25%;">
                            ...
                            <div class="report-summary-sub">Claimed: &#8369;{{ number_format($totalClaimedAmount, 2) }}
                            </div>
                        </td>
                        <td class="report-summary-cell" style="width: 25%;">
                            <div class="report-summary-title">Top Barangay</div>
                            <div class="report-summary-val"
                                style="font-size: 11pt; line-height: 1.2; word-break: break-word;"
                                title="{{ $topBarangay ?? 'N/A' }}">{{ $topBarangay ?? 'N/A' }}</div>
                            <div class="report-summary-sub">{{ number_format($topBarangayCount) }} recorded recipients
                            </div>
                        </td>
                        <td class="report-summary-cell" style="width: 25%;">
                            ...
                            <div class="report-summary-val"
                                style="font-size: 11pt; line-height: 1.2; word-break: break-word;"
                                title="{{ $topSector ?? 'N/A' }}">{{ $topSector ?? 'N/A' }}</div>
        ...
        <div class="report-section section-barangay mb-3">
            <div class="report-section-heading">1. Geographic Distribution of Beneficiaries (Per Barangay) &bull; {{
                $isAll ? 'Overall Records' : $selectedMonthLabel }}</div>
            <table class="report-table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="text-align: right; font-weight: 600;">{{ number_format($bData['beneficiaries']) }}
                        </td>
                        <td style="text-align: right; color: #166534; font-weight: 600;">{{
                            number_format($bData['claimed']) }}</td>
                        <td style="text-align: right; font-weight: 600;">&#8369;{{ number_format($bData['amount'], 2) }}
                        </td>
                    </tr>
                    @empty
                    <tr>
                    ...
                    <tr>
                        ...
                        <td style="font-weight: 600; color: #64748B;">Other Barangays ({{ $otherBarangaysCount }}
                            remaining)</td>
                        <td style="text-align: right; font-weight: 600; color: #64748B;">{{
                            number_format($otherBarangaysBeneficiaries) }}</td>
                        <td style="text-align: right; font-weight: 600; color: #64748B;">{{
                            number_format($otherBarangaysClaimed) }}</td>
                        <td style="text-align: right; font-weight: 600; color: #64748B;">&#8369;{{
                            number_format($otherBarangaysAmount, 2) }}</td>
                    </tr>
                    @endif
                </tbody>
                <tfoot>
                    <tr class="report-table-total-row">
                        <td colspan="2" style="font-weight: 700;">Total Recorded ({{ $allBarangaysCount }} Barangays
                            &bull; {{ $isAll ? 'Overall' : $selectedMonthLabel }})
                        </td>
                        <td style="text-align: right; font-weight: 700;">{{ number_format($totalBeneficiaries) }}</td>
                        <td style="text-align: right; font-weight: 700; color: #166534;">{{ number_format($totalClaimed)
                            }}</td>
                        <td style="text-align: right; font-weight: 700;">&#8369;{{ number_format($totalAmount, 2) }}
                        </td>
                    </tr>
                </tfoot>
            </table>
        ...
        <div class="report-section section-gender mb-3">
            <div class="report-section-heading">2. Beneficiaries Demographic Breakdown by Sex &bull; {{ $isAll ?
                'Overall Records' : $selectedMonthLabel }}</div>
            <table class="report-table">
                <thead>
                    <tr>
                ...
                <tfoot>
                    <tr class="report-table-total-row">
                        <td colspan="2" style="font-weight: 700;">Total Recorded ({{ $isAll ? 'Overall' :
                            $selectedMonthLabel }})</td>
            ...
            <div class="d-flex justify-content-between align-items-center p-2 mt-2 bg-light border rounded"
                style="font-size: 8pt;">
                <div>
                ...
                <div>
                    ...
                    <span class="fw-bold text-dark">{{ $femaleCount >= $maleCount ? 'Female Beneficiaries' : 'Male
                        Beneficiaries' }}</span>
                </div>
            </div>
        </div>
        ...
        <div class="report-page-header-mini mb-3">
            <div class="d-flex justify-content-between align-items-center pb-2 border-bottom border-secondary">
                ...
                <div class="small text-muted" style="font-size: 7.5pt;">
                    STEP 2: FINANCIAL ASSISTANCE &amp; ANALYTICS &bull; STATISTICAL REPORT (PAGE 2) &bull; {{ $isAll ?
                    'ALL MONTHS' : strtoupper($selectedMonthLabel) }}
                </div>
            </div>
        </div>
        ...
        <div class="report-section section-sectors mb-3">
            <div class="report-section-heading">3. Financial Assistance by Sector (Ranked Distribution) &bull; {{ $isAll
                ? 'Overall Records' : $selectedMonthLabel }}</div>
            <table class="report-table">
                <thead>
                    <tr>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="text-align: right; font-weight: 600;">{{ number_format($item['beneficiaries']) }}
                        </td>
                    ...
                    <tr>
                        <td style="text-align: center; color: #64748B;">—</td>
                        <td style="font-weight: 600; color: #64748B;">Other Sectors ({{ $otherSectorsCount }} remaining)
                        </td>
                        <td style="text-align: right; font-weight: 600; color: #64748B;">{{
                            number_format($otherSectorsBeneficiaries) }}</td>
                        <td style="text-align: right; color: #64748B;">
                            {{ $totalBeneficiaries > 0 ? round(($otherSectorsBeneficiaries / $totalBeneficiaries) * 100,
                            1) : 0 }}%
                        </td>
                        <td style="text-align: right; font-weight: 600; color: #64748B;">&#8369;{{
                            number_format($otherSectorsAmount, 2) }}</td>
                    </tr>
                    @endif
                </tbody>
                <tfoot>
                    <tr class="report-table-total-row">
                        <td colspan="2" style="font-weight: 700;">Total Evaluated ({{ $allSectorsCount }} Sectors &bull;
                            {{ $isAll ? 'Overall' : $selectedMonthLabel }})</td>
                        <td style="text-align: right; font-weight: 700;">{{ number_format($totalSectorBeneficiaries) }}
                        </td>
                        <td style="text-align: right; font-weight: 700;">—</td>
                        <td style="text-align: right; font-weight: 700;">&#8369;{{ number_format($totalSectorAmount, 2)
                            }}</td>
                    </tr>
                </tfoot>
            </table>
        ...
        <div class="report-section section-medical mb-3">
            <div class="report-section-heading">4. Most Common Medical Concerns &amp; Assistance Reasons &bull; {{
                $isAll ? 'Overall Records' : $selectedMonthLabel }}</div>
            <p class="report-table-subtext mb-2">Frequently reported medical conditions, diagnostic requests, and
                emergency assistance reasons evaluated for Step 2 assistance.</p>
            ...
            <table class="report-table">
                ...
                <tbody>
                    ...
                    <tr>
                        <td style="text-align: center; color: #64748B;">—</td>
                        <td style="font-weight: 600; color: #64748B;">Other Concerns ({{ $otherMedCount }} remaining)
                        </td>
                        <td style="text-align: right; font-weight: 600; color: #64748B;">{{
                            number_format($otherMedBeneficiaries) }}</td>
                        <td style="text-align: right; color: #64748B;">
                            {{ $totalBeneficiaries > 0 ? round(($otherMedBeneficiaries / $totalBeneficiaries) * 100, 1)
                            : 0 }}%
                        </td>
                        <td style="text-align: right; font-weight: 600; color: #64748B;">&#8369;{{
                            number_format($otherMedAmount, 2) }}</td>
                    </tr>
                    @endif
                </tbody>
                <tfoot>
                    <tr class="report-table-total-row">
                        <td colspan="2" style="font-weight: 700;">Total Evaluated ({{ $allMedCount }} Concerns &bull; {{
                            $isAll ? 'Overall' : $selectedMonthLabel }})</td>
                        <td style="text-align: right; font-weight: 700;">{{ number_format($totalMedBeneficiaries) }}
                        </td>
                        <td style="text-align: right; font-weight: 700;">—</td>
                        <td style="text-align: right; font-weight: 700;">&#8369;{{ number_format($totalMedAmount, 2) }}
                        </td>
                    </tr>
                </tfoot>
            </table>
        ...
        <div class="report-section section-signatures">
            <div class="report-notes-box mb-3">
                <div class="fw-bold text-uppercase mb-1" style="font-size: 7.5pt; color: #1E293B;">Administrative Notes
                    &amp; Data Verification</div>
                <p class="mb-0" style="font-size: 7pt; color: #475569; line-height: 1.4;">
                    This document represents the consolidated official electronic record extracted from the Municipal
                    Social Welfare and Development Office (MSWDO) Financial Assistance &amp; Step 2 Payroll Database
                    under the Assistance to Individuals in Crisis Situations (AICS) Program. All statistical and
                    disbursement records reflect validated intakes and approved financial assistance grants.
                </p>
            </div>
            ...
            <div class="report-signatures-section">
                <div class="row">
                    <div class="col-6 text-center">
                        ...
                        <div class="fw-bold text-dark mt-1" style="font-size: 9pt;">{{
                            session('financial_step2_authorized_user') ?? session('admin_user_name') ?? 'MSWDO Staff /
                            Statistician' }}</div>
                        <div class="text-muted"
                            style="font-size: 7.5pt; text-transform: uppercase; letter-spacing: 0.03em;">Prepared by /
                            Reporting Officer</div>
                    </div>
                    <div class="col-6 text-center">
                        <div class="signature-space"></div>
                        <div class="signature-line mx-auto"></div>
                        <div class="fw-bold text-dark mt-1" style="font-size: 9pt;">Municipal Social Welfare &amp;
                            Development Officer</div>
                        <div class="text-muted"
                            style="font-size: 7.5pt; text-transform: uppercase; letter-spacing: 0.03em;">Noted &amp;
                            Approved by</div>
                    </div>
                </div>
            </div>
            ...
            <div class="report-official-footer d-flex justify-content-between align-items-center mt-3 pt-2 border-top text-muted"
                style="font-size: 7pt;">
                <span>MSWDO Silang, Cavite &bull; Financial Assistance Step 2 Module &bull; Confidential Official Report
                    (Period: {{ $isAll ? 'All Months' : $selectedMonthLabel }})</span>
