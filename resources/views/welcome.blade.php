            ...
            <div class="contact-grid">
                ...
                <div class="emergency-card">
                    ...
                    <div id="emergencyGrid" class="emergency-grid">
                        ...
                        <div class="hotline-item hidden-mobile"><span class="hotline-label">DSWD Central Office:</span> <span
                        ...
                        <div class="hotline-item hidden-mobile"><span class="hotline-label">Makabata Helpline:</span> <span
                                class="hotline-value">1383</span></div>
                        <div class="hotline-item hidden-mobile"><span class="hotline-label">Bantay Bata Hotline:</span> <span
                                class="hotline-value">163</span></div>
                        <div class="hotline-item hidden-mobile"><span class="hotline-label">Emergency (All):</span> <span
                                class="hotline-value">911</span></div>
                        <div class="hotline-item hidden-mobile"><span class="hotline-label">NCMH Mental Health:</span> <span
                                class="hotline-value">1553</span></div>
                        <div class="hotline-item hidden-mobile"><span class="hotline-label">Complaints Hotline:</span> <span
                                class="hotline-value">8888</span></div>
                        <div class="hotline-item hidden-mobile"><span class="hotline-label">Anti-Trafficking Line:</span> <span
                                class="hotline-value">1343</span></div>
                        <div class="hotline-item hidden-mobile"><span class="hotline-label">PNP Women's Desk:</span> <span
                                class="hotline-value">117</span></div>
                        <div class="hotline-item hidden-mobile"><span class="hotline-label">Medical Assistance:</span> <span
                    ...
                    <button id="showAllHotlines" class="lg:hidden mt-4 text-warm-gold font-semibold text-sm hover:underline">
                        Show All
                    </button>
                </div>
            </div>
