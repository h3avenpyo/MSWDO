            ...
            <div class="flex items-center justify-between h-20">
                ...
                <nav class="hidden lg:flex items-center gap-8 text-offwhite">
                    ...
                    <div class="sidebar-foot">
                        <a href="/admin" class="flex items-center gap-2 text-xs"
    ...
    <section id="home" class="relative overflow-hidden pt-40 pb-56 border-b border-slate-200/50 bg-[#F8FAFC]">
        ...
        <div class="mobile-header">
            <button id="mobileMenuBtn" class="mobile-menu-btn" onclick="toggleSidebar()">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                    stroke="currentColor" class="mobile-menu-icon">
                    <path stroke-linecap="round" stroke-linejoin="round"
                        d="M3.75 6.75h16.5m-16.5 5.25h16.5m-16.5 5.25h16.5" />
                </svg>
            </button>
            ...
            <div class="relative max-w-7xl mx-auto px-6 z-10">
                <div class="max-w-3xl mx-auto text-center">
                    ...
                    <p class="mt-4 text-[#6B7280] text-base md:text-lg leading-relaxed max-w-2xl mx-auto">
                        Providing compassionate protection, development opportunities, and responsive welfare assistance
                        to
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                        ...
                        <div
                            ...
                            <div>
                                ...
                                <p class="text-slate-600 text-xs mt-3 leading-relaxed">
                                    Emergency financial, medical, burial, and transportation assistance for individuals
                                    and
                                    families in crisis.
                                </p>
                            </div>
                        ...
                        <div
                            ...
                            <div>
                                ...
                                <p class="text-slate-600 text-xs mt-3 leading-relaxed">
                                    Social pension applications, ID issuances, and community-centered assistance
                                    programs
                        ...
                        <div
                            ...
                            <div>
                                ...
                                <p class="text-slate-600 text-xs mt-3 leading-relaxed">
                                    Formal social case study reports for hospitalization, medicines, burial referrals,
                                    and
        ...
        <style>
            ...
            .hamburger-btn:focus {
                outline: none;
                box-shadow: 0 0 0 3px rgba(26, 35, 126, 0.4);
            }
            ...
            <div class="contact-container">
                <div class="contact-header">
                    ...
                    <p class="contact-description">
                        Reach out to the Municipal Social Welfare and Development Office. We're here to help and answer
                        any
